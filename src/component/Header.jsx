            ...
            <nav className="flex justify-between items-center px-4 py-2 bg-white text-black">
                ...
                <div className="flex items-center space-x-4 h-10 rounded-full border border-white w-[50%]">
                    ...
                    <div className="flex items-center w-full rounded-full bg-gray-50 border border-gray-300">
                        <input type="text" placeholder="Search" className="bg-white border border-gray-300 rounded-s-full p-2 w-[90%] h-[100%]"/>
                        <button className="bg-gray-50 text-white h-full w-[8%] ml-3 hover:bg-gray-200"><img src="https://img.icons8.com/ios-glyphs/30/search--v1.png" alt="search--v1" className=" mx-auto px-2"/></button>
                    </div>
                    {/* Microphone button */}
